...
from app.schemas.imagenes import ImagenCreate, ImagenRead
...
def listar_por_dispositivo(id_dispositivo: int, db: Session = Depends(get_db)):
    return crud_imagenes.get_imagenes_por_dispositivo(db, id_dispositivo)
